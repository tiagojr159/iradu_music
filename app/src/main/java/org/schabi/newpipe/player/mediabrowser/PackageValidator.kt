...
internal class PackageValidator(context: Context) {
    ...
    private val knownCarPackages = setOf(
        // Android Auto
        "com.google.android.projection.gearhead",
        // Some head units/variants use these helpers
    ...
    fun isKnownCaller(callingPackage: String, callingUid: Int): Boolean {
        ...
        val isCallerKnown = when {
            // Allow Android Auto / car integrations to connect.
            callingPackage in knownCarPackages -> true
