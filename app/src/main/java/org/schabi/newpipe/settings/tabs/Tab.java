...
public abstract class Tab {
    ...
    public static class IraduProfileTab extends Tab {
        ...
        @Override
        public String getTabName(final Context context) {
            return context.getString(R.string.iradu_profile_tab_title);
        }
        ...
        @Override
        public IraduProfileFragment getFragment(final Context context) {
            return new IraduProfileFragment();
        }
    }
    ...
    public static class LiveNewsTab extends Tab {
        ...
        @Override
        public String getTabName(final Context context) {
            return context.getString(R.string.iradu_live_news_tab_title);
        }
    ...
    public static class TechNewsTab extends Tab {
        ...
        @Override
        public String getTabName(final Context context) {
            return context.getString(R.string.iradu_tech_tab_title);
        }
